...
/// what the interpreter observed to the <c language="csharp">.play</c> file a developer continues authoring from.
/// </summary>
public interface IScreenplayGenerator
{
    ...
    /// <summary>
    /// Generates the <c language="csharp">.play</c> source text for an extracted event model.
    /// </summary>
    /// <param name="result">The <see cref="ExtractionResult"/> to generate from.</param>
    /// <returns>The rendered <c language="csharp">.play</c> source text.</returns>
