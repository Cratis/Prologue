...
/// and naming conventions) to the built-in Screenplay type names. An unrecognized type maps to <c language="csharp">String</c> — the
...
public static class ScreenplayTypeMapping
{
    ...
    /// </summary>
    /// <param name="type">The extracted property type (for example <c language="csharp">Guid</c> or <see langword="string"/>).</param>
