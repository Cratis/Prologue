...
/// it wants applied, the descriptions for the (renamed) modules, features, and slices, and the questions it needs
/// answered before it can decide. The deterministic heuristics own the structure; this is everything the language
/// model is allowed to contribute.
/// </summary>
...
/// <param name="Descriptions">The descriptions keyed by <c>module:&lt;module&gt;</c>, <c>feature:&lt;module&gt;/&lt;feature&gt;</c>, and <c>slice:&lt;module&gt;/&lt;feature&gt;/&lt;slice&gt;</c> — the keys refer to the renamed names.</param>
