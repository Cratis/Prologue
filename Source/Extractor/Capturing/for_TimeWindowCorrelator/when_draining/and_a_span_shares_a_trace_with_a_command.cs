...
public class and_a_span_shares_a_trace_with_a_command : a_correlator
{
    ...
    void Establish()
    {
        ...
        // The span occurs after the correlation window but shares the command's trace id.
        _correlator.Add(Span(_origin + TimeSpan.FromMilliseconds(1500), "abcabcabcabcabcabcabcabcabcabc01"));
    }
    ...
    [Fact] void should_correlate_the_span_with_the_command_by_trace_id() => _result[0].Entries.Count.ShouldEqual(2);
}
#endif
