...
/// <summary>
/// Represents the OTLP/gRPC metric receiver. It captures metric metadata from every export and forwards the request
...
/// <param name="factory">The factory that maps metrics to observations.</param>
/// <param name="forwarder">The forwarder to the upstream collector.</param>
public class OtlpMetricsGrpcService(
    IObservationChannel channel,
    MetricObservationFactory factory,
    GrpcMetricsForwarder forwarder) : MetricsService.MetricsServiceBase
{
    /// <inheritdoc/>
